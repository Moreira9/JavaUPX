...
public class EditarCadastroAluno extends javax.swing.JFrame {

    private int codCadastro = 0;
    private AlunoServico servico = new AlunoServico();

    public EditarCadastroAluno() {
        initComponents();
        setLocationRelativeTo(null);

    }

    public EditarCadastroAluno(int cod) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Aluno1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCadastroAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarCadastroAluno().setVisible(true);
            }
        });
    }
